...
<a-entity id="cameraRig">
    <a-entity position="0 0 0" control-height>
        ...
        <a-entity move-controls="target: cameraRig" spawn-sphere="event: menudown; distanceStart: 0.3" interaction vive-controls="hand: left" teleport-controls="cameraRig: #cameraRig; button: trigger; collisionEntities: #floor, #floor1, #floor2, #ramp, #ramp1, [mixin = platform]; curveShootingSpeed:15;">
