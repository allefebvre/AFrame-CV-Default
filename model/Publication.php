...
class Publication {
    ...
    function toStringForm(): string {
        $toReturn = "<table>"                
                    . "<tr>"
                        . "<td>Reference* :</td>"
                        . "<td><input name=\"reference\" value=\"$this->reference\" type=\"text\" size=\"10\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Authors* :</td>"
                        . "<td><input name=\"authors\" value=\"$this->authors\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Title* :</td>"
                    ...
                    . "<tr>"
                        . "<td>Journal :</td>"
                        . "<td><input name=\"journal\" value=\"$this->journal\" type=\"text\" size=\"100\"></td></tr>"
                    . "<tr>"
                        . "<td>Volume :</td>"
                        . "<td><input name=\"volume\" value=\"$this->volume\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Number :</td>"
                        . "<td><input name=\"number\" value=\"$this->number\" type=\"text\" size=\"100\"></td></tr>"
                    . "<tr>"
                        . "<td>Pages :</td>"
                        . "<td><input name=\"pages\" value=\"$this->pages\" type=\"text\" size=\"100\"></td></tr>"
                    . "<tr>"
                        . "<td>Note :</td>"
                        . "<td><textarea name=\"note\" rows=\"5\" cols=\"100\">".$this->note."</textarea></td>"
                    . "<tr>"
                        . "<td>Abstract :</td>"
                        . "<td><textarea name=\"abstract\" rows=\"5\" cols=\"100\">" .$this->abstract."</textarea></td>"
                    . "<tr>"
                        . "<td>Keyword :</td>"
                        . "<td><input name=\"keywords\" value=\"$this->keywords\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Series :</td>"
                        . "<td><input name=\"series\" value=\"$this->series\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Localite :</td>"
                        . "<td><input name=\"localite\" value=\"$this->localite\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Publisher :</td>"
                        . "<td><input name=\"publisher\" value=\"$this->publisher\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Editor :</td>"
                        . "<td><input name=\"editor\" value=\"$this->editor\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Pdf :</td>"
                        . "<td><input name=\"pdf\" value=\"$this->pdf\" type=\"text\" size=\"100\"></td>"
                    . "</tr>"
                    . "<tr>"
                        . "<td>Date display :</td>"
