...
class OtherGatewayTest extends TestCase {
    ...
    public function test() {
        ...
        $connection->executeQuery("INSERT INTO `Other` (reference, authors,"
                ...
                . " 'authors', 'title', '2000-01-01', 'journal', 'volume', '1',"
                . " '50', 'note', 'abstract', 'keywords', 'series', 'localite',"
                . " 'publisher', 'editor', 'pdf', 'date_display', '5');");

        $gw = new OtherGateway(new Connection($base, $login, $password));
        $result = $gw->getAllOthers();
